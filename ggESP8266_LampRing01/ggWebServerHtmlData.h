...
<body onload='javascript:initAll()'>
  ...
  <table border='0' cellspacing='3' cellpadding='0'width='100%' class='selectnone'>
    ...
    <tr><td>
      <input id='mCenterBrightnessRange' type='range' min='0' max='1' step='0.01' value='0' class='range_slider'>
    </td></tr>
    ...
    <tr><td>
      <input id='mRingColorRangeH' type='range' min='0' max='255' step='1' value='0' class='range_slider'>
    </td></tr>
    <tr><td>
      <input id='mRingColorRangeS' type='range' min='0' max='255' step='1' value='0' class='range_slider'>
    </td></tr>
    <tr><td>
      <input id='mRingColorRangeV' type='range' min='0' max='255' step='1' value='0' class='range_slider'>
    </td></tr>
